 ...
 * @since 2026-03-01
 */
@TableName("ct_examination")
@Schema(description = "CT检查专项表")
public class CtExamination implements Serializable {
     ...
     * 检查部位（如"胸部+上腹部"）
     */
    @Schema(description = "检查部位（如\"胸部+上腹部\"）")
     ...
     * CT报告PDF文件访问链接
     */
    @Schema(description = "CT报告PDF文件访问链接")
    private String reportUrl;

    /**
     * CT影像DICOM/图片文件访问链接（多文件用逗号分隔）
     */
    @Schema(description = "CT影像DICOM/图片文件访问链接（多文件用逗号分隔）")
