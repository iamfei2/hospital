...
import com.hospit.entity.CtImportTemplate;
...
public class CtExcelImportListener extends AnalysisEventListener<CtImportTemplate> {
    ...
    public CtExcelImportListener(ImportContext context) {
        this.context = context;
    }

    @Override
    public void invoke(CtImportTemplate template, AnalysisContext analysisContext) {
        if (isFirstRow) {
            isFirstRow = false;
            return;
        }
        ...
        try {
            CtExamination entity = convertToEntity(template);
    ...
    private String validateRow(CtImportTemplate template) {
    ...
    private String buildRawData(CtImportTemplate template) {
    ...
    private CtExamination convertToEntity(CtImportTemplate template) {
        CtExamination entity = new CtExamination();
