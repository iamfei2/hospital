...
public interface CtExaminationMapper extends BaseMapper<CtExamination> {

    // 查询已存在的检查编号
    @Select("<script>" +
            "SELECT examination_no FROM ct_examination WHERE is_invalid = 0 AND examination_no IN " +
