...
public class ExaminationPathMapping extends XmlPathMapping {
    ...
    public static final String EXAMINATION_PART = "ExaminationInfo/Part";
    ...
    public void initialize() {
        ...
        addMapping(EXAMINATION_PART, "examinationPart");
